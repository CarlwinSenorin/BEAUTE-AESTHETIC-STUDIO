...
<?php include '../includes/admin-header.php'; ?>
            ...
            <!-- Stats Cards -->
            <div class="stats-row" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 15px; margin-bottom: 25px;">
                <div class="admin-card" style="text-align: center; padding: 20px;">
                    <div style="font-size: 2rem; font-weight: 700; color: var(--primary-color, #e91e63);"><?php echo $total_items; ?></div>
                    <div style="color: #888; font-size: 0.9rem;">Total Items</div>
                </div>
                <div class="admin-card" style="text-align: center; padding: 20px;">
                    <div style="font-size: 2rem; font-weight: 700; color: #ff9800;"><?php echo $low_count; ?></div>
                    <div style="color: #888; font-size: 0.9rem;">Low Stock</div>
                </div>
                <div class="admin-card" style="text-align: center; padding: 20px;">
                    <div style="font-size: 2rem; font-weight: 700; color: #f44336;"><?php echo $out_count; ?></div>
                    <div style="color: #888; font-size: 0.9rem;">Out of Stock</div>
                </div>
                <div class="admin-card" style="text-align: center; padding: 20px;">
                    <div style="font-size: 2rem; font-weight: 700; color: #4caf50;"><?php echo formatPrice($total_value); ?></div>
                    <div style="color: #888; font-size: 0.9rem;">Total Value</div>
                </div>
            </div>
                ...
                <form method="POST" class="admin-form">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="<?php echo htmlspecialchars($edit_item['name'] ?? ''); ?>" required placeholder="e.g. Gel Nail Polish">
                        </div>
                        <div class="form-group">
                            <label>Category</label>
                            <input type="text" name="category" value="<?php echo htmlspecialchars($edit_item['category'] ?? 'General'); ?>" required placeholder="e.g. Nail Supplies">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="reorder_level" value="<?php echo $edit_item['reorder_level'] ?? 5; ?>" min="0" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="cost_per_unit" value="<?php echo $edit_item['cost_per_unit'] ?? 0; ?>" min="0" step="0.01">
                        </div>
                    </div>
